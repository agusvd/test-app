...
const MenuDown = () => {
    ...
    const isAmigos = location.pathname === '/amigos'
    ...
    return (
        <div className='sticky bottom-0'>
            <div className='bg-white text-black dark:text-white dark:bg-black justify-around flex p-1 items-center'>
                ...
                <Link to="/amigos" className='text-sm text-center items-center flex flex-col cursor-pointer hover:scale-110 duration-100 transition-all ease-in'>
                    <div className='relative text-sm text-center items-center flex flex-col'>
                        ...
                        {isAmigos ? <AiTwotoneFire size={30} /> : <AiOutlineFire size={30}/>
                        }                      
                        Amigos
                    </div>
                </Link>
